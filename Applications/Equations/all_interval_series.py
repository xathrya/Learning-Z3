# Solving interval series problem
#
# Use: 
#    python algebra.py 
# 
...
# Finds sequences of length n-1 of integers 0, ... , n-1 such that the difference of the n-1
...
# more than just finite domains (Booleans, Bit-vectors, enumeration types
