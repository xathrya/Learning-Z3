...
# For all 9 rows
for r in range(9):
    s.add(Distinct(cells[r][0], cells[r][1], cells[r][2], 
                    cells[r][3], cells[r][4], cells[r][5], 
                    cells[r][6], cells[r][7], cells[r][8]))

# For all 9 columns
for c in range(9):
    s.add(Distinct(cells[0][c], cells[1][c], cells[2][c], 
...
for r in range(0, 9, 3):
    for c in range(0, 9, 3):
        # Add constraints for each 3*3 squares
        s.add(Distinct(cells[r+0][c+0], cells[r+0][c+1], cells[r+0][c+2], 
                    cells[r+1][c+0], cells[r+1][c+1], cells[r+1][c+2], 
                    cells[r+2][c+0], cells[r+2][c+1], cells[r+2][c+2]))
