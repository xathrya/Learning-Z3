...
Norwegian, Ukrainian, Englishman, Spaniards, Japanese = Ints('Norwegian Ukrainian Englishman Spaniards Japanese')
...
# All nationalities lives in different houses:
s.add(Distinct(Norwegian, Ukrainian, Englishman, Spaniards, Japanese))
...
# Limit the numbers,
# Adding two constraints at once (separated by comma) is the same as adding
# one And() constraint with several subconstraints
...
# 15.The Norwegian lives next to the blue house.
s.add(Or(Norwegian == Blue - 1, Norwegian == Blue + 2))
